<div style="background-image: url('{{ asset('images/birth.png') }}'); background-size: cover; background-position: center; min-height: 100vh; width: 100%;">
<x-slot name="header">
                ...
                <form wire:submit.prevent="store">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="type1_id" wire:model="selectedTypes.0" class="mt-1 block w-full" required>
                        ...
                        <div>
                            ...
                            <select id="type2_id" wire:model="selectedTypes.1" class="mt-1 block w-full">
                                @foreach($types as $type)
                                    <option value="{{ $type->id }}">{{ $type->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select id="attack1_id" wire:model="selectedAttacks.0" class="mt-1 block w-full">
                        ...
                        <div>
                            ...
                            <select id="attack2_id" wire:model="selectedAttacks.1" class="mt-1 block w-full">
                                <option value="">None</option>
                                @foreach($attacks as $attack)
                                    <option value="{{ $attack->id }}">{{ $attack->name }}</option>
                                @endforeach
                        ...
                        <div>
                            ...
                            <input id="image" type="file" wire:model="image" class="mt-1 block w-full">
                            @if ($image)
                                <img src="{{ $image->temporaryUrl() }}" alt="Image Preview" class="mt-2 w-20 h-20 object-cover">
                            @endif
                        </div>
                    </div>
